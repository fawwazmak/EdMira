...
const Navbar = () => {
  ...
  const navItems = ["Home", "About", "Forum", "News Feed"];
  ...
  return (
    <div>
  <div className="sticky top-0 left-0 w-full bg-[#FDFDFD] shadow-md z-50 flex items-center justify-between px-6 md:px-12 h-20">
    {/* Logo */}
    <motion.img
      src="/Logo1.jpg"
      alt="EdMira Logo"
