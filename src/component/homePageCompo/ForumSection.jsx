...
const ForumSection = () => {
  ...
  return (
    <Box sx={{ fontFamily: "'Inter', 'Segoe UI', sans-serif",
            background: "linear-gradient(135deg, #082E39 0%, #0a3d4f 100%)",
            minHeight: "100vh", py: 8, px: 4, }}
        >
          {/* Header Section */}
          <Container maxWidth="lg" className="text-center mb-20">
            ...
            <Typography
              variant="h6"
              sx={{ color: "#C7BC9A", maxWidth: "720px", mx: "auto" }}
            >
              ...
              <Grid item xs={12} lg={6}>
                ...
                >
                  <div
                    ...
                    style={{
                      background:
                        "radial-gradient(circle, rgba(203, 162, 68, 0.2) 0%, transparent 70%)",
                    }}
                  />
                  <Typography
                    variant="h4"
